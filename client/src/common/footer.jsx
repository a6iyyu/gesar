...
export const Footer = () => {
  const Menus = [ "Blog", "Konsultasi", "Permainan", "FAQ", "Tentang Kami", "Kritik & Saran"];

  return (
    <footer className="h-fit w-full bg-gradient-to-r from-[#141b1f] to-[#1a1f25] pb-20 pt-12 lg:-mt-10">
