  ...
  return (
    <main className="z-10 h-fit w-full bg-gradient-to-r from-[#ac906d] to-[#ba8c54] pb-20">
      <Link to="/tentang-kami">
        <section className="mx-auto h-full w-4/5 rounded-xl bg-[#d0be8f] bg-cover bg-center bg-no-repeat text-white transition-all duration-300 ease-in-out [background-image:_url('/kenal-lebih-dekat.jpg?url')] [box-shadow:0.3rem_0.3rem_0_#bcbcbc50] lg:bg-contain lg:bg-right lg:text-[#006400] lg:hover:scale-[1.025]">
