  ...
  return (
    <main className="z-10 h-fit w-full bg-gradient-to-r from-[#ac906d] to-[#ba8c54] pb-20">
      <Link to="/tentang-kami">
        <section className="mx-auto h-full w-4/5 rounded-xl bg-[#d0be8f] bg-cover bg-center bg-no-repeat text-[#006400] transition-all duration-300 ease-in-out [background-image:_url('/kenal-lebih-dekat.jpg?url')] [box-shadow:0.3rem_0.3rem_0_#bcbcbc50] lg:bg-contain lg:bg-right lg:hover:scale-[1.025]">
          <h4 className="group hidden h-fit w-1/2 p-12 text-justify font-medium leading-relaxed text-[#006400] lg:inline-block">
