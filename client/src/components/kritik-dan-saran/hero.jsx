...
export const KritikDanSaranHero = () => {
  return (
    <main className="mx-auto my-20 flex h-fit w-4/5 flex-col-reverse items-center text-[#006400] lg:grid lg:grid-cols-2">
      ...
      <section className="flex cursor-default flex-col justify-center">
        ...
        <h1 className="mt-10 inline text-center text-4xl font-bold leading-tight lg:mt-0 lg:hidden lg:text-left">
          Bantu Kami Menjadi&nbsp;
          <br className="inline lg:hidden" />
          Lebih Baik
        </h1>
        <h4 className="mt-4 text-justify text-base font-medium tracking-wide [text-align-last:center] lg:[text-align-last:left]">
      ...
      <ReactParallaxTilt className="flex h-full w-full justify-end">
        <img src="/feedback.png?url" alt="Feedback" className="h-[27rem] w-fit object-contain transition-all duration-300 ease-in-out" />
      </ReactParallaxTilt>
    </main>
  );
};