...
export const Registrasi = () => {
  ...
  const HandleSubmit = e => MenanganiPengiriman(e, RegisterSkema, registerData, setErrorForm, "auth/registrasi", "masuk", setShowNotification);
          ...
          <form onSubmit={HandleSubmit} className="mx-auto mt-10 h-fit w-4/5">
            ...
            <div className="mt-5 flex flex-col justify-between sm:flex-row">
              ...
              <span className="mt-2 flex h-fit w-fit items-start sm:mt-0 lg:items-end">
                <Link to="/masuk" className="transition-all duration-300 ease-in-out lg:hover:text-[#006400] lg:hover:underline">
                  Sudah punya akun?
                </Link>
              </span>
            </div>
            <button type="submit" className="mx-auto mt-12 h-fit w-full rounded-lg bg-[#006400] py-4 text-base font-semibold text-slate-50 transition-all duration-300 ease-in-out md:py-5 lg:hover:bg-[#006400]">
              Registrasi
            </button>
          </form>
          <span className="h-fit w-4/5">
            <Link to="https://localhost:4001/auth/google">
              <button type="submit" className="mx-auto mt-7 flex h-fit w-full items-center justify-center gap-x-3 rounded-lg bg-slate-100 py-4 text-base font-semibold text-slate-950 transition-all duration-300 ease-in-out md:py-5 lg:hover:bg-slate-200">
