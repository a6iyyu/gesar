...
export const KritikDanSaranSkema = z.object({
  email: z.string().trim().email({ message: "Email tidak valid!" }).regex(/(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])*")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\])/g, { message: "Surel Anda tidak valid!" }).min(1, { message: "Surel tidak boleh kosong!" }),
  subject: z.string().trim().regex(/(?:[a-zA-Z0-9!%&+/=-`"])/g, { message: "Subjek Anda tidak valid!" }).min(1, { message: "Subjek tidak boleh kosong!" }).max(100, { message: "Subjek tidak boleh lebih dari 100 karakter!" }),
